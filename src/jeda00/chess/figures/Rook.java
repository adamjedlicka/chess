...
public class Rook extends Figure {
    ...
    public Rook(Board board, Color color, String coords) {
    ...
    public List<Move> getPossibleMoves() {
        ...
        try {
            ...
            for (int i = 1; i < Board.DIMENSION; i++) {
                coords = getCoords().moveRightBy(i);
